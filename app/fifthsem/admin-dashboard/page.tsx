...
export default function AdminDashboard() {
  ...
  const fetchTeacherFeedback = async () => {
    setLoading(true)
    try {
      const response = await fetch(`/api/feedback/get-by-teacher?semester=5&teacherId=${teachers[selectedTeacher].id}`)
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Header */}
      <div className="bg-linear-to-r from-blue-600 to-blue-700 text-white py-6 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-bold">Admin Dashboard - Fifth Semester</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {teachers.map((teacher, idx) => (
              <div
                ...
                className={`p-4 rounded cursor-pointer transition ${selectedTeacher === idx
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
                  ...
                  <div className="text-right">
                    ...
                    <p>
                      <span className="font-bold">SEMESTER:</span> 3RD
                    </p>
                    <p>
