...
export default function AdminDashboard() {
  ...
  const fetchTeacherFeedback = async () => {
    setLoading(true)
    try {
      const response = await fetch(`/api/feedback/get-by-teacher?semester=3&teacherId=${teachers[selectedTeacher].id}`)
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-linear-to-r from-blue-600 to-blue-700 text-white py-6 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-bold">Admin Dashboard - Third Semester</h1>
