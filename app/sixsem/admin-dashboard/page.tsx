...
export default function AdminDashboard() {
  ...
  const fetchTeacherFeedback = async () => {
    setLoading(true)
    try {
      const response = await fetch(`/api/feedback/get-by-teacher?semester=6&teacherId=${teachers[selectedTeacher].id}`)
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-6 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-bold">Admin Dashboard - Sixth Semester</h1>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
                      <div>
                        ...
                        <p>
                          <span className="font-bold">YEAR:</span> 3RD YEAR
                        </p>
                      </div>
                      <div className="text-right">
                        ...
                        <p>
                          <span className="font-bold">SEMESTER:</span> 6TH
                        </p>
                        <p>
