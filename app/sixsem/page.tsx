    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-slate-900 mb-3">Sixth Semester Feedback</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          {/* Admin Login Card */}
          <Link href="/sixsem/admin-login" className="group">
            <div className="bg-white rounded-xl border-2 border-slate-200 hover:border-indigo-500 shadow-sm hover:shadow-lg transition-all duration-200 p-8 h-full flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-200">
          ...
          {/* Student Login Card */}
          <Link href="/sixsem/student-login" className="group">
            <div className="bg-white rounded-xl border-2 border-slate-200 hover:border-indigo-500 shadow-sm hover:shadow-lg transition-all duration-200 p-8 h-full flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-200">
                <svg className="w-8 h-8 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-slate-600 text-sm mb-6">Submit feedback for your sixth semester courses</p>
              <div className="mt-auto flex items-center text-indigo-600 font-medium group-hover:translate-x-1 transition-transform">
                Continue
                <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
        ...
        {/* Info Section */}
        <div className="mt-12 bg-indigo-50 border border-indigo-200 rounded-lg p-6 max-w-3xl mx-auto">
